...
class Pin:
    ...
    def display(self):
        p = self
        print(
            "- pin_name %s: component_idx %s, pin_type %s, rotation: %s, net: %s, (%s), path: %s"
            % (
                p.pin_name,
                p.component.idx,
                p.type,
...
class Component:
    def __init__(
        ...
        self.waveguide_type = (
            waveguide_type  # Waveguide Type, referring to Waveguides.XML
        )
    ...
    def display(self):
        ...
        for c in cc:
            c.npins = len(c.pins)
            text = (
                "- basic_name: %s, component: %s-%s / %s; transformation: %s; center position: %s; number of pins: %s; optical pins: %s; electrical pins: %s; optical IO pins: %s; has compact model: %s; params: %s."
                % (
                    c.basic_name,
                    c.component,
                    c.idx,
