...
Ag_JohnsonChristy1972 = VariantItem(
    medium=PoleResidue(
        ...
        poles=(
            (
                (-1306213662214179.8 - 6200791340906446j),
                (5316579866298263 + 770314552771784.5j),
            ),
            (
...
Al_Rakic1995 = VariantItem(
    medium=PoleResidue(
        ...
        poles=[
            ...
            (
                (-1373449221156.457 + 1j * 0.0),
                (7.630343339215653e16 + 1j * 2.252091523762478e17),
            ),
            (
...
Al2O3_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.856240967961668e16), (0.0 + 1j * 1.4107431356508676e16))
        ],
...
AlN_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.354578856633347e16), (0.0 + 1j * 2.2391188500149228e16))
        ],
...
CaF2_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 2.376134288665943e16), (0.0 + 1j * 1.2308375615289586e16))
        ],
        frequency_range=(181349193170394.5, 1148544890079165.2),
    ),
    reference=[material_refs["Horiba"]],
...
Cellulose_Sultanova2009 = VariantItem(
    medium=PoleResidue(
        eps_inf=1,
        poles=[
            ((0.0 + 1j * 1.7889308287957964e16), (-0.0 - 1j * 1.0053791257832376e16))
        ],
...
MgF2_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 2.5358092974503356e16), (0.0 + 1j * 1.1398462792039258e16))
        ],
...
PMMA_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.7360669128251744e16), (0.0 + 1j * 1.015599144002727e16))
        ],
...
PMMA_Sultanova2009 = VariantItem(
    medium=PoleResidue(
        eps_inf=1,
        poles=[
            ((0.0 + 1j * 1.7709719337156064e16), (-0.0 - 1j * 1.0465558642292376e16))
        ],
        frequency_range=(284973819943865.75, 686338046201801.2),
    ),
    reference=[material_refs["Sultanova2009"]],
...
PVC_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.8551774807480708e16), (0.0 + 1j * 1.209575717447742e16))
        ],
...
Polycarbonate_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.8240324980641504e16), (0.0 + 1j * 1.3716724385442412e16))
        ],
...
Sapphire_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 2.0143967092980652e16), (0.0 + 1j * 2.105044561216478e16))
        ],
...
Si3N4_Philipp1973 = VariantItem(
    medium=PoleResidue(
        eps_inf=1,
        poles=[
            ((0.0 + 1j * 1.348644355236665e16), (-0.0 - 1j * 1.9514209498096924e16))
        ],
...
SiC_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=3.0,
        poles=[
            ((-0.0 - 1j * 1.2154139583969018e16), (0.0 + 1j * 2.3092865209541132e16))
        ],
        frequency_range=(145079354536315.6, 967195696908770.8),
    ),
    reference=[material_refs["Horiba"]],
...
SiON_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.651139862482191e16), (0.0 + 1j * 1.1079148477255502e16))
        ],
...
Ti_Werner2009 = VariantItem(
    medium=PoleResidue(
        ...
        poles=[
            (
                (-55002727357489.695 - 1j * 103457301057900.64),
                (0.0 + 1j * 1.4157836508658926e18),
            ),
            (
                (-3889516074161299.0 - 1j * 6.314261108475189e16),
                (0.0 + 1j * 2192302508847248.2),
            ),
            (
                (-2919746613155850.5 - 1j * 7.211858151732786e16),
                (0.0 + 1j * 744301222539582.0),
            ),
            (
                (-4635394958195360.0 - 1j * 5.622429893839941e16),
                (0.0 + 1j * 2101343798471838.0),
            ),
            (
                (-9774364062177540.0 - 1j * 4844300045008988.0),
                (0.0 + 1j * 7.377824793744533e16),
            ),
        ],
        frequency_range=(120884055879414.03, 2997924585809468.0),
    ),
...
Y2O3_Horiba = VariantItem(
    medium=PoleResidue(
        eps_inf=1.0,
        poles=[
            ((-0.0 - 1j * 1.3814698904628784e16), (0.0 + 1j * 1.1846104310719182e16))
        ],
