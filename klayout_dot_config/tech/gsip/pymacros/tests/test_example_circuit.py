...
def example_circuit():
    ...
    # Waveguides:
    connect_pins_with_waveguide(
        instGC1, "opt_wg", instY1, "opt1", waveguide_type=waveguide_type
    )
    connect_pins_with_waveguide(
        instGC2, "opt_wg", instY2, "opt1", waveguide_type=waveguide_type
    )
    connect_pins_with_waveguide(
        instY1, "opt2", instY2, "opt3", waveguide_type=waveguide_type
    )
    connect_pins_with_waveguide(
        instY1,
        "opt3",
