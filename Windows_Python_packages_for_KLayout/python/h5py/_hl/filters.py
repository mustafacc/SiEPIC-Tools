...
def fill_dcpl(
    ...
    if scaleoffset is not None:
        ...
        if dtype.kind == "f":
            ...
            raise TypeError(
                "scale/offset filter only supported for integer "
        ...
        if fletcher32:
            raise ValueError(
                "fletcher32 cannot be used with potentially lossy"
                " scale/offset filter"
            )
...
def get_filters(plist):
    ...
    filters = {
        h5z.FILTER_DEFLATE: "gzip",
        h5z.FILTER_SZIP: "szip",
        h5z.FILTER_SHUFFLE: "shuffle",
        h5z.FILTER_FLETCHER32: "fletcher32",
        h5z.FILTER_LZF: "lzf",
        h5z.FILTER_SCALEOFFSET: "scaleoffset",
    }
